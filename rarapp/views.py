    ...
    if "adminId" in request.session or "managerId" in request.session:
        ...
        if allotment_entries.exists():
            ...
            context = {
                                         ...
                                         "total_allotted_time"                      : total_allotted_time_percentage,
                                                                                    # round(total_allotted_time, 2)
                                         ...
                                         "completion_status_percentage_rounded"     : round(
                                               completion_status_percentage,
                                                                                           ),
            ...
            messages.error (
                             ...
                             request, 
                            "There are no approved allotments for this project."
